      ...
      <ul className="list-none flex space-x-4 pt-4 place-items-center">
        <li className="">
          ...
          <div
            className={
              showMessage
                ? 'z-20 absolute w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700 right-48'
                : 'hidden'
            }>
              ...
              <a href="#" className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                <div className="flex-shrink-0">
                  <img
                    ...
                    alt="Jese image"
                  />
                  <div clclassNameass="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 bg-blue-600 border border-white rounded-full dark:border-gray-800">
                    <svg
        ...
        <li>
          ...
          <div
            className={
              showNotification
                ? 'z-20 absolute w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700 right-36'
                : 'hidden'
            }>
            <div class="block px-4 py-2 font-medium text-center text-gray-700 rounded-t-lg bg-gray-50 dark:bg-gray-800 dark:text-white">
              Notifications
